 ...
 * 
 */
@WebServiceClient(name = "UserServiceImplService", targetNamespace = "http://ws.webservice.com/", wsdlLocation = "http://localhost:8089/ws/users?wsdl")
    ...
    extends Service
{
    ...
    private final static QName USERSERVICEIMPLSERVICE_QNAME = new QName("http://ws.webservice.com/", "UserServiceImplService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8089/ws/users?wsdl");
    ...
    public UserService getUserServiceImplPort() {
        return super.getPort(new QName("http://ws.webservice.com/", "UserServiceImplPort"), UserService.class);
    }
    ...
    public UserService getUserServiceImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://ws.webservice.com/", "UserServiceImplPort"), UserService.class, features);
    }
